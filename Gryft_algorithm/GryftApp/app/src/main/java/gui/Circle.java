...
public class Circle extends JPanel {
    ...
    public static final android.graphics.Color DEFAULT_TRUCK_COLOR = android.graphics.Color.BLUE;
    public static final android.graphics.Color DEFAULT_NODE_COLOR = android.graphics.Color.BLACK;
    public static final android.graphics.Color DEFAULT_PARCEL_COLOR = android.graphics.Color.RED;
